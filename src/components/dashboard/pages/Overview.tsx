...
export default function Overview() {
  ...
  const stats = [
    { label: 'Total Revenue', value: `$${totalRevenue.toLocaleString()}`, change: '+18%', icon: TrendingUp, color: 'text-emerald-600', bg: 'bg-emerald-50' },
              ...
              <div key={p.name} className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <p className="text-sm font-bold text-slate-700 ml-2">${p.revenue.toLocaleString()}</p>
                  </div>
