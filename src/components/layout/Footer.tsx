...
export default function Footer() {
  return (
    <footer className="bg-teal-900 text-teal-200/75">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2">
            ...
            <div className="flex gap-3">
              ...
              <a href="https://x.com/storee_io" target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg bg-teal-800 flex items-center justify-center hover:bg-teal-700 hover:text-white transition-colors">
          ...
          {/* Product */}
          <div>
            <h4 className="text-teal-50 font-semibold mb-4">Product</h4>
            <ul className="space-y-3 text-sm">
              {['AI Store Builder', 'Templates', 'Pricing', 'Changelog', 'Roadmap'].map(item => (
                <li key={item}><a href="#" className="hover:text-teal-50 transition-colors">{item}</a></li>
              ))}
            </ul>
          </div>
          ...
          {/* Resources */}
          <div>
            <h4 className="text-teal-50 font-semibold mb-4">Resources</h4>
            <ul className="space-y-3 text-sm">
          ...
          {/* Company */}
          <div>
            <h4 className="text-teal-50 font-semibold mb-4">Company</h4>
            <ul className="space-y-3 text-sm">
        ...
        <div className="pt-8 border-t border-teal-800 flex flex-col sm:flex-row items-center justify-between gap-4">
