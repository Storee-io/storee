...
export default function Footer() {
  return (
    <footer className="text-white/80" style={{ background: 'linear-gradient(90deg, #10b981, #14b8a6)' }}>
          ...
          <div className="col-span-2">
            ...
            <div className="flex gap-3">
              ...
              <a href="https://x.com/storee_io" target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg bg-white/15 flex items-center justify-center hover:bg-white/25 hover:text-white transition-colors">
