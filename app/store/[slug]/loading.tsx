    ...
    <>
      <style>{`
        ...
        @keyframes sk-bar {
          ...
          60%  { transform: scaleX(0.80); }
          85%  { transform: scaleX(0.93); }
          100% { transform: scaleX(1);    }
        }
        .sk-bar {
          animation: sk-bar 2.2s cubic-bezier(0.1,0.6,0.4,1) forwards;
      ...
      {/* Progress bar */}
      <div className="fixed top-0 left-0 right-0 h-[3px] z-50 overflow-hidden bg-slate-100">
        <div className="sk-bar h-full w-full bg-slate-300" />
      </div>
      ...
      <div className="sk-wrap min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 pb-4 flex items-center justify-between">
          <div className="sk h-6 w-44 rounded-xl" />
          <div className="sk h-4 w-16" />
        </div>

        {/* Product grid */}
        <section className="max-w-7xl mx-auto px-6 pt-4 pb-14">
